...
REQUIREMENTS = ['requests-oauthlib==1.1.0', 'oauthlib==2.1.0', 'https://github.com/dre2004/python-fitbit/archive/master.zip#fitbit==0.3.0']
...
class FitbitAuthCallbackView(HomeAssistantView):
    ...
    def get(self, request):
        ...
        if data.get('code') is not None:
            ...
            try:
                _LOGGER.error("Test %s %s", data.get('code'), redirect_uri)
